...
public class CalibrateBackElevatorMotor extends CommandBase {
  /** Creates a new CalibrateBackElevatorMotor. */
  private AttachmentSubsystem m_AttachmentSubsystem;
  public CalibrateBackElevatorMotor(AttachmentSubsystem attachmentSubsystem) {
  ...
  public void initialize() {
    ...
    m_AttachmentSubsystem.backRotatorArm.set(.05);
  }
  ...
  public void end(boolean interrupted) {
    m_AttachmentSubsystem.backRotatorArm.set(0);
